    ...
    <Container style={{height:'100vh'}} className="bg-1 d-flex align-items-center justify-content-center">
        ...
        <div className="row align-items-center">
          <div className="col-12 col-md-6 p-3">
            <img src="https://i.pinimg.com/originals/87/6f/9c/876f9c5858d664d0efa0c476db65ef87.gif" alt="" className="w-100" />
          </div>
          <div className="col-12 col-md-6 p-3">
            ...
            <Link to="/regi" className="mx-1"><Button className="bg-primary">new user</Button></Link>
